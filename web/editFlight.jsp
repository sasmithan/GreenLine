<%-- 
    Document   : user
    Created on : Aug 26, 2019, 7:38:53 PM
    Author     : SasmithaN
--%>
	...
	<body>
            <script>
                function emptyBox(){
                    ...
                    var conpsd=document.getElementById("conpsd").value;
                    var utype=document.getElementById("utype").value;
                    if(psd==""|name==""|email==""|dob==""|password==""|passport==""|contact==""|conpsd==""|utype=""){
                        
                        alert('Fill the blank fields first');
                        ...
                        document.getElementById("conpsd").style.borderColor="red";
                        document.getElementById("utype").style.borderColor="red";
                        
                        return false;
                    }
                    else if(psd.length<6){
                        alert('password lenght must be greater than 6 characters');
                         document.getElementById("psd").style.borderColor="red";
                        return false;
                    }
                    else if(psd.length>10){
                        alert('password lenght must be less than 10 characters');
                         document.getElementById("psd").style.borderColor="red";
                        return false;
                    }
                    else if(psd!=conpsd){
                       
                        alert('password not same value');
                         document.getElementById("psd").style.borderColor="red";
                        return false;
		...
		<!-- end:header-top -->
                ...
                <div class="fh5co-hero" style="height: 1200px">
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      <li role="presentation" class="active">
								      	<a href="#addFlight" aria-controls="addFlight" role="tab" data-toggle="tab">Add New Flight</a>
								      </li>
								   ...
								   <!-- Tab panes -->
									<div class="tab-content">
									 <div role="tabpanel" class="tab-pane active" id="addFlight" >
										<div class="row">
                                                                                   
                                                                                      <form action="updateFlight.jsp" method="get" onsubmit="return emptyBox()">
                                                                                          <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Flight ID:</label>
                                                                                                        <input type="text" class="form-control" value="${tempUser.flight_id}" name="flight_id" id="flight_id" disabled/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Flight type:</label>
                                                                                                        <input type="text" class="form-control" value="${tempUser.flight_type}" name="flight_type" id="flight_type"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Airport:</label>
                                                                                                        <input type="text" class="form-control" value="${tempUser.airport}" name="airport" id="airport"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Terminal:</label>
                                                                                                        <input type="text" class="form-control" value="${tempUser.terminal}" name="terminal" id="terminal"/>
												</div>
											</div>
                                                                                        <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Departure:</label>
                                                                                                        <input type="text" class="form-control" value="${tempUser.departure}" name="departure" id="departure"/>
												</div>
											</div>
                                                                                        <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Arrival:</label>
                                                                                                        <input type="text" class="form-control" value="${tempUser.arrival}" name="arrival" id="arrival"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">From:</label>
                                                                                                        <input type="text" class="form-control" value="${tempUser.from_place}" name="from_place" id="from_place"/>
												</div>
											</div>
                                                                                        <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">To:</label>
                                                                                                        <input type="text" class="form-control" name="to_place" value="${tempUser.to_place}" id="to_place"/>
												</div>
											</div>
											<div class="col-xs-12">
