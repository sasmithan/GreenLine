									...
									<div class="tab-content">
									 <div role="tabpanel" class="tab-pane active" id="addFlight" >
										<div class="row">
                                                                                      ...
                                                                                      <form action="flightController" method="get" onsubmit="return emptyBox()">
												<input type="hidden" name="command" value="ADD">
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Flight type:</label>
                                                                                                        <input type="text" class="form-control" name="flight_type" id="flightType"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
											...
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">From:</label>
                                                                                                        <input type="text" class="form-control" name="from_place" id="from_place"/>
												</div>
											</div>
                                                                                        <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
