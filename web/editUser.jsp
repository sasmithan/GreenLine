								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      ...
								      <li role="presentation" class="active">
								    	   <a href="#signin" aria-controls="signin" role="tab" data-toggle="tab">Edit Passenger Information</a>
								      </li>
								   ...
								   <!-- Tab panes -->
									<div class="tab-content">
									 ...
									 <div role="tabpanel" class="tab-pane active" id="signin">
									 	<div class="row">
                                                                                    <form action="updateInfo.jsp" method="get" onsubmit="return emptyBox()">
                                                                                     
                                                                                        <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Name:</label>
                                                                                                        <input type="email" class="form-control" name="email" value="${tempUser.email}" id="email" disabled/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Name:</label>
													<input type="text" class="form-control" name="name" value="${tempUser.name}" id="name" />
												</div>
											</div>
												...
												<div class="input-field">
													...
													<input type="number" class="form-control" name="contact" value="${tempUser.contact}" id="contact"/>
												</div>
											</div>
											...
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
													...
													<input type="text" class="form-control" id="dob" name="dob" value="${tempUser.dob}" placeholder="MM/DD/YYYY"/>
												</div>
											</div>
											...
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													...
													<input type="password" class="form-control" name="password" value="${tempUser.password}" id="password"/>
												</div>
											</div>
