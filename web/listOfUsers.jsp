	...
	<body>
		...
		<div class="fh5co-hero">
            ...
            <c:forEach var="tempUser" items="${USER_LIST}">
               ...
               <c:url var="editLink" value="userController">
                    <c:param name="command" value="EDIT_PAGE"/>
                    <c:param name="email" value="${tempUser.email}"/>
                </c:url>
                 <c:url var="profileLink" value="userController">
                ...
                <tr>
                    ...
                    <td><c:out value="${tempUser.passport}"/></td>
                    <td><c:out value="${tempUser.contact}"/></td>
                    <td><c:out value="${tempUser.dob}"/></td>
                   
                     <td><a href="${editLink}">Edit</a></td>
                    <td><a href="${deleteLink}">Delete</a></td>
                    <td><a href="${profileLink}">Profile</a></td>
