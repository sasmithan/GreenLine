<%-- 
    Document   : adminPAge
    Created on : Aug 26, 2019, 9:23:26 PM
    Author     : SasmithaN
--%>
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li>
								<a href="#" class="fh5co-sub-ddown">FLIGHT OPTION</a>
								<ul class="fh5co-sub-menu">
                                                                    <li><a href="addFlight.jsp">Add Flight</a></li>
									<li><a href="flightController">View Flight</a></li>
									
									
								</ul>
							</li>
							<li><a href="#">HOLIDAYS</a></li>
                                                        <li><a href="userController">VIEW ALL USERS</a></li>
                                                        <li><a href="adminRegister.jsp">REGISTER PASSENGER</a></li>
                                                        <li><a href="#"><%
