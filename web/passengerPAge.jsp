				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a href="flightController?command=PASSENGER_VIEW_LIST">View Flight</a></li>
							<li>
                                                            <a href="#"><%
                                                    String id=session.getAttribute("email").toString();
                                                    out.print("Passenger: "+id);
                                                    %></a></li>
                                                        <li><a href="userController?command=EDIT_PAGE&email=<%=id%>">Edit</a></li>
                                                         <li><a href="userController?command=PROFILE&email=<%=id%>">Profile</a></li>
								   ...
								   <ul class="nav nav-tabs" role="tablist">
								      ...
								      <li role="presentation">
								    	   <a href="#manage" aria-controls="manage" role="tab" data-toggle="tab">Manage</a>
                                                                       ...
                                                                       <li role="presentation" class="active-controls">
									...
									<div class="tab-content">
									 <div role="tabpanel" class="tab-pane active" id="book">
										<div class="row">
												...
												<div class="" style="
                                                                                                    ...
                                                                                                    ">
                                                                                                    <input type="radio" name="option" value="Return">Return &nbsp;&nbsp;
                                                                                                        <input type="radio" name="option" value="One way">One way &nbsp;&nbsp;
                                                                                                        <input type="radio" name="option" value="Redeem">Redeem &nbsp;&nbsp;
                                                                                                </div>
											</div>
											...
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													...
													<input type="text" class="form-control" id="from-place" placeholder="Departure Airport"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">To:</label>
													<input type="text" class="form-control" id="to-place" placeholder="Arrival Airport"/>
												</div>
											</div>
									 ...
									 <div role="tabpanel" class="tab-pane" id="hotels">
									 	<div class="row">
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Destination/hotel name:</label>
													<input type="text" class="form-control" id="from-place" placeholder="e.g. country, city, district or landmark"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
									 ...
									 <div role="tabpanel" class="tab-pane" id="manage">
									 	<div class="row">
                                                                                    <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">To access an existing booking, please enter the information below and click "Retrieve Now". You will be able to review your travel details</label>
												</div>
											</div>
                                                                                <div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
										...
										<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">Booking Reference:</label>
													<input type="text" class="form-control" id="from-place" />
												</div>	
                                                                                </div>	
											...
											<div class="col-xs-12">
												<input type="submit" class="btn btn-primary btn-block" value="Retrieve Now">
											</div>
										</div>
									 </div>
									 	...
									 	<div class="row">
											<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Online Check-in facility is available 48 hours to 2 hours before flight departure. 
All our check-in counters close 01 hour prior to departure. The data collected in this form are subject to the Privacy Policy of GreenLines Limited.</label>
													</div>
											</div>
                                                                                    <div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													...
													<input type="text" class="form-control" id="from-place" />
                                                                                    ...
                                                                                    <div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">Ticket No:</label>
													<input type="text" class="form-control" id="from-place" />
												</div>
											</div>
											...
											<div class="col-xs-12">
												<input type="submit" class="btn btn-primary btn-block" value="Check-in Now">
											</div>
										</div>
									 </div>
									 	...
									 	<div class="row">
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">From:</label>
													<input type="text" class="form-control" id="from-place" placeholder="Origin"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">To:</label>
													<input type="text" class="form-control" id="to-place" placeholder="To"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
									 	...
									 	<div class="row">
											...
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">Flight Number UL:</label>
