	...
	<body>
            <script>
                function emptyBox(){
                    ...
                    if(psd==""|name==""|email==""|dob==""|passport==""|contact==""|conpsd==""|utype==""){
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      ...
								      <li role="presentation" class="active">
								    	   <a href="#signin" aria-controls="signin" role="tab" data-toggle="tab">Profile</a>
								      </li>
								   ...
								   <!-- Tab panes -->
									<div class="tab-content">
									 ...
									 <div role="tabpanel" class="tab-pane active" id="signin">
									 	<div class="row">
                                                                                    <table width="100px" height="300px" border="0" cellspacing="5">
												
  <tbody>
  
      <tr  style="float: none;">
       
      <td style="color:black;font-size: 18px;padding-left:40px;">Name</td>
      <td style="color:black;font-size: 18px;padding-left:40px;">:${tempUser.name}</td>
        </div>
    </tr>
    <tr >
      <td style="color:black;font-size: 18px;padding-left:40px;">Email</td>
      <td style="color:black;font-size: 18px; padding-left:40px;">:${tempUser.email}</td>
    </tr>
    <tr >
      <td style="color:black;font-size: 18px;padding-left:40px;">Passpord</td>
      <td style="color:black;font-size: 18px; padding-left:40px;">:${tempUser.passport}</td>
    </tr>
    <tr >
      <td style="color:black;font-size: 18px;padding-left:40px;">ContactNo</td>
      <td style="color:black;font-size: 18px; padding-left:40px;">:${tempUser.contact}</td>
    </tr>
    <tr >
      <td style="color:black;font-size: 18px;padding-left:40px;">DOB</td>
      <td style="color:black;font-size: 18px; padding-left:40px;">:${tempUser.dob}</td>
    </tr>
    <tr >
      <td style="color:black;font-size: 18px;padding-left:40px;">Password</td>
      <td style="color:black;font-size: 18px; padding-left:40px;">:${tempUser.password}</td>
    </tr>
