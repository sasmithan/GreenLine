									...
									<div class="tab-content">
									 <div role="tabpanel" class="tab-pane active" id="login" >
										<div class="row">
                                                                                     ...
                                                                                     <form action="Login" method="post" onsubmit="return emptyBox()">
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">User ID:</label>
                                                                                                        <input type="email" class="form-control" name="email" id="uid" placeholder="email"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="password">Password:</label>
													<input type="password" class="form-control" name="password" id="upsd" placeholder="********"/>
												</div>
											</div>
									 ...
									 <div role="tabpanel" class="tab-pane" id="signin">
									 	<div class="row">
                                                                                    <form action="userController" method="get" onsubmit="return emptyBox()">
												...
												<div class="" style="
                                                                                                    ...
                                                                                                    ">
                                                                                                    <input type="radio" name="utype" id="utype" value="A">Admin &nbsp;&nbsp;
                                                                                                    <input type="radio" name="utype" id="utype" value="P">Passenger &nbsp;&nbsp;
											...
											<div class="col-xxs-12 col-xs-12 mt">
												...
												<div class="input-field">
													...
													<input type="text" class="form-control" name="passport" id="port" />
												</div>
											</div>
                                                                                    <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Contact No:</label>
													<input type="number" class="form-control" name="contact" id="cno" />
												</div>
											</div>
                                                                                    
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
													<label for="date-start">Dob:</label>
											...
											<div class="col-xxs-12 col-xs-12 mt">
												...
												<div class="input-field">
													...
													<input type="password" class="form-control" id="conpsd"/>
												</div>
											</div>
											<div class="col-xs-12">
